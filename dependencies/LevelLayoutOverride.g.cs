...
{
	/// <summary>
	/// Override metadata for LevelLayoutOverride
	/// </summary>
	public partial class LevelLayoutOverride : IOverride
	{
        public static string Name = "Level Layout";
        public static string Dependency = null;
        public static string Context = "[*discriminator=Elements.LevelLayout]";
	...
	public static class LevelLayoutOverrideExtensions
    {
		/// <summary>
        /// Apply Level Layout edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Level Layout Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<LevelLayoutOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, LevelLayoutIdentity, bool> identityMatch,
            Func<T, LevelLayoutOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Level Layout Overrides to apply — typically `input.Overrides.LevelLayout`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<LevelLayoutOverride> overrideData,
            Func<T, LevelLayoutIdentity, bool> identityMatch,
            Func<T, LevelLayoutOverride, T> modifyElement
            ) where T : Element
        {
