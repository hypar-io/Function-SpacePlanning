...
namespace SpacePlanning
{
    ...
    public  class SpacePlanningInputs : ArgsBase
    
    {
        [Newtonsoft.Json.JsonConstructor]
        
        public SpacePlanningInputs(bool? @autocreateSpaces, Overrides @overrides, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
